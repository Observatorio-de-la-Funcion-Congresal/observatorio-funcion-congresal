export const icons = [
  {
    category: 'home',
    name: 'home',
    path: '<path d="M5.77778 10.2222V18C5.77778 19.1046 6.67321 20 7.77778 20H12M5.77778 10.2222L11.2929 4.70711C11.6834 4.31658 12.3166 4.31658 12.7071 4.70711L17.5 9.5M5.77778 10.2222L4 12M18.2222 10.2222V18C18.2222 19.1046 17.3268 20 16.2222 20H12M18.2222 10.2222L20 12M18.2222 10.2222L17.5 9.5M17.5 9.5V6M12 20V15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'home',
    name: 'home-2',
    path: '<path d="M5.77777 11.0507C5.77777 10.5202 5.98848 10.0115 6.36356 9.63644L11.2929 4.70711C11.6834 4.31658 12.3166 4.31658 12.7071 4.70711L17.6364 9.63644C18.0115 10.0115 18.2222 10.5202 18.2222 11.0506V18C18.2222 19.1046 17.3268 20 16.2222 20H12H7.77777C6.6732 20 5.77777 19.1046 5.77777 18V11.0507Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'user',
    name: 'user',
    path: '<path d="M5 20V19C5 16.2386 7.23858 14 10 14H14C16.7614 14 19 16.2386 19 19V20M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'user',
    name: 'user-delete',
  ...
  },
  {
    category: 'user',
    name: 'user-check',
    path: '<path d="M14 18L16 20L22 14M4 20V19C4 16.2386 6.23858 14 9 14H12.75M15 7C15 9.20914 13.2091 11 11 11C8.79086 11 7 9.20914 7 7C7 4.79086 8.79086 3 11 3C13.2091 3 15 4.79086 15 7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'user',
    name: 'user-circle',
    path: '<path d="M16.9696 19.5047C16.7257 17.5293 15.0414 16 13 16H11C8.95858 16 7.27433 17.5293 7.03036 19.5047M16.9696 19.5047C19.3986 17.893 21 15.1335 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 15.1335 4.60137 17.893 7.03036 19.5047M16.9696 19.5047C15.5456 20.4496 13.8371 21 12 21C10.1629 21 8.45441 20.4496 7.03036 19.5047M15 10C15 11.6569 13.6569 13 12 13C10.3431 13 9 11.6569 9 10C9 8.34315 10.3431 7 12 7C13.6569 7 15 8.34315 15 10Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'user',
    name: 'user-group',
    path: '<path d="M3 19V18C3 15.7909 4.79086 14 7 14H11C13.2091 14 15 15.7909 15 18V19M15 11C16.6569 11 18 9.65685 18 8C18 6.34315 16.6569 5 15 5M21 19V18C21 15.7909 19.2091 14 17 14H16.5M12 8C12 9.65685 10.6569 11 9 11C7.34315 11 6 9.65685 6 8C6 6.34315 7.34315 5 9 5C10.6569 5 12 6.34315 12 8Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'user',
    name: 'user-add',
  ...
  },
  {
    category: 'arrows',
    name: 'arrow-up',
    path: '<path d="M12 20L12 4M12 4L18 10M12 4L6 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-down',
    path: '<path d="M12 4L12 20M12 20L6 14M12 20L18 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-left',
    path: '<path d="M20 12H4M4 12L10 6M4 12L10 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-right',
    path: '<path d="M4 12L20 12M20 12L14 18M20 12L14 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-up-left',
    path: '<path d="M17.6569 17.6569L6.34317 6.34323M6.34317 6.34323H14.8285M6.34317 6.34323V14.8285" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-up-right',
    path: '<path d="M6.34319 17.6569L17.6569 6.34317M17.6569 6.34317L17.6569 14.8285M17.6569 6.34317L9.17161 6.34317" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-down-left',
    path: '<path d="M17.6568 6.34312L6.3431 17.6568M6.3431 17.6568V9.17154M6.3431 17.6568H14.8284" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'arrow-down-right',
    path: '<path d="M6.34312 6.34319L17.6568 17.6569M17.6568 17.6569L9.17154 17.6569M17.6568 17.6569L17.6568 9.17161" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'chevron-up',
    path: '<path d="M5 15L11.2929 8.70711C11.6834 8.31658 12.3166 8.31658 12.7071 8.70711L19 15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'chevron-down',
    path: '<path d="M19 9L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L5 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'chevron-left',
    path: '<path d="M15.5 19L9.20711 12.7071C8.81658 12.3166 8.81658 11.6834 9.20711 11.2929L15.5 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'arrows',
    name: 'chevron-right',
    path: '<path d="M9.5 5L15.7929 11.2929C16.1834 11.6834 16.1834 12.3166 15.7929 12.7071L9.5 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'validation',
    name: 'backspace',
  ...
  },
  {
    category: 'validation',
    name: 'sort',
    path: '<path d="M4 7H20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 12L14 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 17H6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'validation',
    name: 'filter',
    path: '<path d="M4 7H20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 12L17 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 17H13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'validation',
    name: 'filter-2',
    path: '<path d="M17.8258 5H6.17422C5.31987 5 4.85896 6.00212 5.41496 6.65079L9.75926 11.7191C9.91461 11.9004 10 12.1312 10 12.3699V17.382C10 17.7607 10.214 18.107 10.5528 18.2764L12.5528 19.2764C13.2177 19.6088 14 19.1253 14 18.382V12.3699C14 12.1312 14.0854 11.9004 14.2407 11.7191L18.585 6.65079C19.141 6.00212 18.6801 5 17.8258 5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'validation',
    name: 'remove',
    path: '<path d="M7 12L17 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'validation',
    name: 'add',
    path: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 12L12 12M12 12L17 12M12 12V7M12 12L12 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'notification',
    name: 'bell',
    path: '<path d="M5.82474 13.934L5.09976 13.2452L5.82474 13.934ZM8 9C8 6.79086 9.79086 5 12 5V3C8.68629 3 6 5.68629 6 9H8ZM8 11.7564V9H6V11.7564H8ZM6 16C6 15.4658 6.20812 14.9823 6.54971 14.6228L5.09976 13.2452C4.41915 13.9616 4 14.9329 4 16H6ZM7 16H6V18H7V16ZM17 16H7V18H17V16ZM18 16H17V18H18V16ZM17.4503 14.6228C17.7919 14.9823 18 15.4658 18 16H20C20 14.9329 19.5809 13.9616 18.9002 13.2452L17.4503 14.6228ZM16 9V11.7564H18V9H16ZM12 5C14.2091 5 16 6.79086 16 9H18C18 5.68629 15.3137 3 12 3V5ZM18.9002 13.2452C18.2923 12.6054 18 12.1579 18 11.7564H16C16 13.05 16.8905 14.0336 17.4503 14.6228L18.9002 13.2452ZM4 16C4 17.1046 4.89543 18 6 18V16H4ZM18 18C19.1046 18 20 17.1046 20 16H18V18ZM6 11.7564C6 12.1579 5.70766 12.6054 5.09976 13.2452L6.54971 14.6228C7.10947 14.0336 8 13.05 8 11.7564H6Z" fill="currentColor"/><path d="M13.7976 19.8767C13.6312 20.2179 13.3712 20.5046 13.048 20.7035C12.7247 20.9023 12.3516 21.0051 11.9721 20.9998C11.5926 20.9945 11.2224 20.8813 10.9049 20.6735C10.5873 20.4657 10.3354 20.1718 10.1786 19.8262" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 3V4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'notification',
    name: 'bell-off',
    path: '<path fill-rule="evenodd" clip-rule="evenodd" d="M6.90904 5.82325C6.33296 6.7445 6 7.83337 6 9V11.7564C6 12.1579 5.70766 12.6054 5.09976 13.2452C4.41915 13.9616 4 14.9329 4 16C4 17.1046 4.89543 18 6 18H7H16C16.8342 18 17.5492 17.4892 17.8492 16.7634L16 14.9142V16H7H6C6 15.4658 6.20812 14.9823 6.54971 14.6228C7.10947 14.0336 8 13.05 8 11.7564V9C8 8.3901 8.1365 7.81208 8.38062 7.29483L6.90904 5.82325ZM16 12.0858V9C16 6.79086 14.2091 5 12 5C11.1288 5 10.3226 5.27854 9.66565 5.75143L8.23901 4.3248C9.26789 3.49606 10.576 3 12 3C15.3137 3 18 5.68629 18 9V14.0858L16 12.0858Z" fill="currentColor"/><path d="M3 3L21 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.7976 19.8767C13.6312 20.2179 13.3712 20.5046 13.048 20.7035C12.7247 20.9023 12.3516 21.0051 11.9721 20.9998C11.5926 20.9945 11.2224 20.8813 10.9049 20.6735C10.5873 20.4657 10.3354 20.1718 10.1786 19.8262" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 3V4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'link',
    path: '<path d="M10 8H6C4.34315 8 3 9.34315 3 11V13C3 14.6569 4.34315 16 6 16H10M9 12H15M14 8H18C19.6569 8 21 9.34315 21 11V13C21 14.6569 19.6569 16 18 16H14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'link-2',
  ...
  },
  {
    category: 'links-&-share',
    name: 'share',
    path: '<path d="M5 12V17C5 18.6569 6.34315 20 8 20H16C17.6569 20 19 18.6569 19 17V12M12 16V4M12 4L8 8M12 4L16 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'share-2',
    path: '<path d="M8 11H6C4.89543 11 4 11.8954 4 13V19C4 20.1046 4.89543 21 6 21H18C19.1046 21 20 20.1046 20 19V13C20 11.8954 19.1046 11 18 11H16M12 17V3M12 3L9 6M12 3L15 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'share-3',
    path: '<path d="M15.2141 7.39294L8.68387 10.6581M8.68387 10.6581C8.19134 9.67492 7.17449 9 6 9C4.34315 9 3 10.3431 3 12C3 13.6569 4.34315 15 6 15C7.17449 15 8.19134 14.3251 8.68387 13.3419M8.68387 10.6581C8.88616 11.0619 9 11.5176 9 12C9 12.4824 8.88616 12.9381 8.68387 13.3419M15.2141 16.6071L8.68387 13.3419M21 6C21 7.65685 19.6569 9 18 9C16.3431 9 15 7.65685 15 6C15 4.34315 16.3431 3 18 3C19.6569 3 21 4.34315 21 6ZM21 18C21 19.6569 19.6569 21 18 21C16.3431 21 15 19.6569 15 18C15 16.3431 16.3431 15 18 15C19.6569 15 21 16.3431 21 18Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'launch',
    path: '<path d="M11 5H7C5.89543 5 5 5.89543 5 7V17C5 18.1046 5.89543 19 7 19H17C18.1046 19 19 18.1046 19 17V12.25M19 5H15M19 5V9M19 5L9 15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'links-&-share',
    name: 'launch-2',
  ...
  },
  {
    category: 'edit',
    name: 'search',
    path: '<circle cx="10" cy="10" r="6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.5 14.5L19 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
  },
  {
    category: 'edit',
    name: 'delete',
...
export const completeSvgIcon = [
  {
    category: 'xls',
    name: 'xls',
    path: '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 96 96"><g transform="matrix(.1 0 0 -.1 0 96)"><path d="M305 845c-223-47-205-15-205-365 0-351-20-318 215-366 94-19 180-32 192-29 13 3 30 16 39 30 16 24 21 25 121 25 117 0 153 12 178 60 12 24 15 74 15 270s-3 246-15 270c-25 48-61 60-180 60-88 0-105 2-105 15 0 24-46 65-72 64-13 0-95-16-183-34m195-366V138l-22 5c-13 3-84 18-158 32-74 15-141 32-147 37-19 15-19 521 0 536 10 8 272 68 315 71 9 1 12-73 12-340m284 245c24-23 24-485 0-508-12-13-38-16-120-16H560v540h104c82 0 108-3 120-16"/><rect x="255" y="505" width="250" height="54" rx="17" transform="rotate(45 380 442)"/><rect x="255" y="505" width="250" height="54" rx="17" transform="rotate(-45 320 582)"/><rect x="600" y="600" width="150" height="60" rx="21"/><rect x="600" y="450" width="150" height="60" rx="21"/><rect x="600" y="300" width="150" height="60" rx="21"/></g></svg>'
  }
]