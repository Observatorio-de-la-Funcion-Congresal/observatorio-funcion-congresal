...
| **founded_year** | `string` | Año de fundación del partido (formato string para flexibilidad) |

### Propiedades de Representación

| Propiedad | Tipo | Descripción |
|-----------|------|-------------|
| **senator_count** | `number` | Cantidad de senadores del partido en el congreso |
| **deputy_count** | `number` | Cantidad de diputados del partido en el congreso |

Usado en: Componente `PartyStats` para mostrar la composición del partido

### Propiedades de Liderazgo

| Propiedad | Tipo | Descripción |
|-----------|------|-------------|
| **leader** | `string` | Nombre del líder/presidente del partido |
| **leader_description** | `string` | Descripción de la trayectoria y rol del líder (ej: "Empresario y político, fundador del partido") |
| **vice_president** | `string` | Nombre del vice-presidente o representante secundario |
| **vice_president_description** | `string` | Descripción del rol del vice-presidente |
| **vice_president_2** | `string` | Nombre de un segundo vice-presidente o representante terciario |
| **vice_president_2_description** | `string` | Descripción del rol del segundo vice-presidente |

Usado en: Componentes `PartyHero` y `PartyTicket` para mostrar la estructura de liderazgo

### Objeto: metrics

Contiene métricas de desempeño agregadas del partido.

| Propiedad | Tipo | Descripción |
|-----------|------|-------------|
| **attendance** | `number` | Promedio de asistencia de los congresistas del partido (0-100) |
| **abstentions** | `number` | Promedio de abstenciones del partido |
| **session_week** | `number` | Participación promedio en sesiones de la semana |
| **accomplishment** | `number` | Índice de cumplimiento/logro del partido (0-100) |
| **projects** | `number` | Promedio de proyectos por miembro del partido |
| **participation** | `number` | Nivel promedio de participación en debates |

Usado en: Componente `PartyMetrics` para mostrar un radar chart del desempeño del partido

### Objeto: distribution

Array que representa la distribución de representantes del partido en diferentes órganos.

| Propiedad | Tipo | Descripción |
|-----------|------|-------------|
| **distribution** | `Array<{name, value}>` | Listado con la distribución de representantes |
...
**Típicos valores de name:**
- "Senadores"
- "Diputados"
- "Parlamento Andino"

Usado en: Componente `PartyAnalysis` para mostrar gráficos de distribución (pie/donut chart)
